...
<cfif thisTag.ExecutionMode IS "start">
	...
	<cfset setupTag("formatdate", false) />
	...
	<!--- Get formatter --->
	<cfset variables.formatter = getAppManager().getGlobalizationManager().getFormatDateTimeInstance(attributes.locale, attributes.pattern) />
...
<cfelse>
	...
	<cfif Len(attributes.value)>
		<!--- Perform formatting --->
		<cfset variables.output = variables.formatter.format(attributes.value) />
