...
--->
<cfcomponent
	displayname="BeanGeneratorListener" 
	extends="MachII.framework.Listener"	
	output="false"
	hint="Basic interface for BeanGenerator tool.">
	...
	PUBLIC FUNCTIONS
	--->
	<cffunction name="saveBeanCFC" access="public" returntype="void" output="false" hint="Save BeanGenerator CFC.">
