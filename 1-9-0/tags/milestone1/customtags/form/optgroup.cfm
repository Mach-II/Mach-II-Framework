...
<cfif thisTag.executionMode IS "start">
	...
	<cfset setAttribute("label") />

	<!--- Set optional attributes --->
	<cfset setAttributeIfDefined("id") />
...
<cfelse>
	<cfif StructKeyExists(attributes, "content")>
		<cfset setContent(attributes.content) />
	<cfelse>
	...
	<cfif attributes.output>
		...
		<cfset appendGeneratedContentToBuffer(doStartTag() & doEndTag(), attributes.outputBuffer) />
	<cfelse>
