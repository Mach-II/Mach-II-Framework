...
<cfcomponent
	...
	<cffunction name="configure" access="public" returntype="void" output="false">
		...
		<cfset appLoader.reloadConfig(arguments.validateXML, getAppManager()) />
	...
	<cffunction name="deconfigure" access="public" returntype="void" output="false"
		hint="Preforms deconfiguration logic on the module.">
		<cfset getModuleAppManager().deconfigure() />
