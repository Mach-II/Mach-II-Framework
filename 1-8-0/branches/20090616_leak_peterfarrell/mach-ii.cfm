...
<cfset application[MACHII_APP_KEY].appLoader.getAppManager().getLog().warn("DEPRECATED: The mach-ii.cfm bootstrapper is deprecated. Please use the mach-ii.cfc bootstrapper for Application.cfc.") />
